...
MENU_PAGES = [
    ...
    },
    {
        ...
        "tab_name": "🧃 2. 無酒精 & 炸物",
        "file": "menu_p2.jpg",
        "desc": "有機野莓洛神檸檬冰茶 ($130/$160)、有機爽身檸檬冰茶 ($120/$160)、椰子氣泡水 ($120)、可樂/雪碧 ($80)、蘇打水 ($80) ｜ 香脆薯條 ($100)、香酥雞塊 ($120)"
    },
    {
        "id": "p3",
    ...
    },
    {
        ...
        "tab_name": "🍸 4. 特色調酒 & 生啤",
        "file": "menu_p4.jpg",
        "desc": "泰式奶茶酒 8% ($300)、紅心芭樂梅 8% ($250)、芭樂梅茶酒 8% ($290)、柚香梅沙瓦 ($260)、伯爵覆盆子 8% ($290)、梅啤氣 ($260)、野莓洛神 4% ($220)、Mojito冰茶 4% ($220)、雷檸紫蘇/荔枝/草莓 ｜ 18天生啤 ($250/$320)、朝日生啤 ($250/$320)、Highball/Lime ($200)"
    },
    {
        "id": "p5",
        ...
        "tab_name": "🍾 5. 敲敲瓶裝 & 燒啤",
        "file": "menu_p5.jpg",
        "desc": "朝日瓶裝 ($160)、雪山啤酒 ($210)、歸剛ㄟ零糖啤酒 ($220)、小滿冬瓜茶啤酒 ($220)、立秋東方美人茶啤酒 ($220)、貓頭鷹蘋果氣泡酒 ($220)、燒酒Somaek ($220)、美韓轟炸機組合 ($390)"
    }
]
